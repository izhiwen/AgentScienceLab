#!/usr/bin/env bash
# AgentScienceLab — acceptance test for v0.1.0 schema.
#
...
# ASL research-tuned consultant team TOML exists, parses, and declares
# all 5 expert seats + 3 user personas + 5 owner gates.
# ---------------------------------------------------------------------
ct="core/templates/consultant-team.agentsciencelab.toml"
